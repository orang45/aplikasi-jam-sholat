...
public class quran_info extends ArrayAdapter<Surah> {

    Context context;
    int resource;

    public quran_info(@NonNull Context context, int resource, @NonNull List<Surah> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Surah soraname = getItem(position);
